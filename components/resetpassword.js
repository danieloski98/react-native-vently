        ...
        return (
            <ScrollView style={{ flex:1, backgroundColor: "white" }}>
                    ...
                    <View testID="texts" style={{ marginTop: "20%"}}>
                        <Text style={{ fontFamily: "Poppins-Medium.ttf", fontSize: 24}}>Welcome</Text>
                        <Text style={{ marginTop: 10}}>Please put in your email to reset your account</Text>
                    </View>
                    ...
                    <View style={{ flexDirection: "row", justifyContent: "center", paddingBottom: 20, marginTop: -20 }}>
                        <Text style={{ textAlign:"center", marginTop: 30}} onPress={() => {}}>
                            Don't have an account? 
                        </Text>
                        <Text onPress={() => this.props.navigation.navigate("Signup")} style={{ color: "#E61648", paddingLeft: 10, marginTop: 30,}}>Sign up</Text>
                    </View>
