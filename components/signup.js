...
import {OnBoardingContext, OnBoardingstate} from '../context/onBoardingstate';
    ...
    try {
      ...
      switch (result.status) {
        case 201: {
          ...
          AsyncStorage.setItem(`${body.user.Email}ID`, id);
          AsyncStorage.setItem(`${body.user.Email}`, email);
          let Userid = await AsyncStorage.getItem(`${body.user.Email}ID`);
          let Useremail = await AsyncStorage.getItem(`${body.user.Email}`);
        ...
        case 500: {
          ...
          Alert.alert('An error occured on our end', 'please try again');
          break;
        }
      }
    } catch (error) {
      ...
      <ScrollView
        ...
        <View style={{paddingLeft: 20, paddingRight: 20}}>
          ...
          <View testID="texts" style={{marginTop: '14%'}}>
            <Text style={{fontFamily: 'Poppins-Medium.ttf', fontSize: 24}}>
              Get Started
            </Text>
            <Text style={{marginTop: 10}}>
              We're glad to have you aboard, signing up is easy
            </Text>
          </View>
          ...
          <View testID="form-fields" style={{marginTop: 20}}>
            <View>
              ...
              {this.isFieldInError('fullname') &&
                this.getErrorsInField('fullname').map((errorMessage, index) => (
          ...
          <View>
            ...
            <View style={{flexDirection: 'row', marginTop: 10}}>
              ...
              {this.state.passwordVisible ? (
                <Icon
                  onPress={() => this.togglePasswordVisibilty()}
                  style={style.eyeIocn}
                  name="md-eye"
                  color="#ABABAB"
                  size={25}
          ...
          <View
            style={{flexDirection: 'row', marginTop: 30, flexWrap: 'nowrap'}}>
            <CheckBox
          ...
          <View
            ...
            <Text
              ...
              style={{color: '#E61648', paddingLeft: 10, marginTop: 10}}>
              Login
            </Text>
          </View>
        </View>
